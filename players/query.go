...
type playerQuery struct {
	...
	Likes          string   `url:"likes,omitempty"`
	PlayStyles     string   `url:"playstyles,omitempty"`
	PlayStylesPlus string   `url:"playstyles_plus,omitempty"`
...
func newPlayerQuery(opt *Options) *playerQuery {
	...
	pq := &playerQuery{
		...
		Likes:          opt.Likes,
		PlayStyles:     opt.PlayStyles,
		PlayStylesPlus: opt.PlayStylesPlus,
